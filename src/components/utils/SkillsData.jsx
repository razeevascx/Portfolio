import {
  ...
  export const skillsData = {
    ...
    frontend: [
      ...
      {
        label: "Tailwind CSS",
        icon: <FaReact />, // You may want to use a different icon for Tailwind CSS
        color: "text-blue-400",
        description:
      ...
      {
        label: "Material UI",
        icon: <FaReact />, // You may want to use a different icon for Material UI
    ...
    tools: [
      ...
      {
        label: "VS Code",
        icon: <FaReact />, // You may want to use a different icon for VS Code
        color: "text-blue-500",
