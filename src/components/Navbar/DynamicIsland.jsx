...
const DynamicIsland = ({ isExpanded, setIsExpanded, activeSection, navLinks }) => {
  const currentNavItem = navLinks.find(link => link.href.substring(1) === activeSection);
        ...
        {isExpanded && (
          ...
          >
            ...
            <div className="flex justify-between items-center mb-2 px-1">
              <span className="text-white/80 text-sm font-medium">Navigation</span>
              <button
