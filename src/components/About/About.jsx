  ...
  const timeline = [
    {
      ...
      description:
        "Pursuing a Bachelor's degree in Computer Science with a focus on modern web development and emerging technologies.",
    },
    {
        ...
        <div className="space-y-12 ">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                I was born on February 22, 2006 AD. Growing up in Bhaktapur, my
                journey in technology began early with access to various
                electronic devices. This early exposure sparked a fascination
                that would later drive me to understand their inner workings.
              </p>
              <p>
                My curiosity led me to complete my secondary education at
                <span className="text-white font-semibold">
                  {' '}
                ...
                . During this time, I developed a small-scale school management
                system using the
