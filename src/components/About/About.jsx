...
import { skillsData, educationData } from "../utils/SkillsData";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              Always eager to learn and implement new technologies. My journey
              as a developer has been a continuous learning process, from
              building small projects to working on complex applications.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 glass-card rounded-lg">
                ...
                <p className="text-2xl font-bold text-white">Below 1 Year</p>
              </div>
              <div className="p-4 glass-card rounded-lg">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Want to collaborate on a project or just say hi? Feel free to reach
            out!
          </p>
          <motion.button
